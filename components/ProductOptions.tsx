      ...
      <div className="bg-white p-6 rounded-2xl shadow-xl w-11/12 max-w-md text-center relative">
        ...
        {isAdminView ? (
          <div className="flex flex-col items-center">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Editando: {product}</h2>
            <AdminDashboard />
            <Button onClick={() => setIsAdminView(false)} className="mt-4 bg-blue-500 hover:bg-blue-600">
              Voltar ao Produto
            </Button>
          </div>
        ) : (
          <>
            ...
            <div className="flex flex-col gap-2 mt-4">
              <Button
                ...
                className="bg-pink-500 text-white font-bold hover:bg-pink-600 transition-all"
